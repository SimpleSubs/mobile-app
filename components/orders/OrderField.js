    ...
    case InputTypes.PICKER:
      return (
        <IngredientPicker
          ...
          useIndexValue={options.useIndexValue}
        />
      );
    case InputTypes.CHECKBOX:
      return (
        <AnimatedDropdown title={title} type={type} selectedValue={value} options={options.values}>
          <Checkboxes selectedItems={value} itemsArr={options.values} setItems={setValue} />
        </AnimatedDropdown>
      );
